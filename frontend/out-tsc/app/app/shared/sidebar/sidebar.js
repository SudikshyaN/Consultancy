...
export class DashboardSidebarComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DashboardSidebarComponent, selectors: [["app-dashboard-sidebar"]], hostAttrs: [1, "app-dashboard-sidebar"], outputs: { logoutClicked: "logoutClicked" }, decls: 15, vars: 0, consts: [[1, "dashboard-sidebar"], [1, "sidebar-brand"], [1, "brand-mark"], [1, "brand-copy"], ["aria-label", "Dashboard", 1, "sidebar-nav"], [1, "sidebar-menu"], ["type", "button", 1, "logout-button", 3, "click"], ["routerLinkActive", "active", 1, "sidebar-item", 3, "routerLink"]], template: function DashboardSidebarComponent_Template(rf, ctx) { if (rf & 1) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DashboardSidebarComponent, [{
        type: Component,
        args: [{ selector: 'app-dashboard-sidebar', standalone: true, imports: [CommonModule, RouterLink, RouterLinkActive], host: {
                    'class': 'app-dashboard-sidebar'
                }, template: "<aside class=\"dashboard-sidebar\">\n  <div class=\"sidebar-brand\">\n    <div class=\"brand-mark\">BP</div>\n    <div class=\"brand-copy\">\n      <strong>Bidesh Padhna</strong>\n      <span>Foreign Education Consultancy</span>\n    </div>\n  </div>\n\n  <nav class=\"sidebar-nav\" aria-label=\"Dashboard\">\n    <ul class=\"sidebar-menu\">\n      @for (item of items; track item.path) {\n        <li>\n          <a\n            [routerLink]=\"item.path\"\n            routerLinkActive=\"active\"\n            class=\"sidebar-item\"\n          >\n            {{ item.label }}\n          </a>\n        </li>\n      }\n    </ul>\n  </nav>\n\n  <button type=\"button\" class=\"logout-button\" (click)=\"logout()\">Logout</button>\n</aside>\n", styles: ["\n.dashboard-sidebar {\n  position:sticky;\n  background: #081f26;\n  border-radius: 24px 0 0 24px;\n  display: flex;\n  flex-direction: column;\n  padding: 20px 16px;\n  width: 240px;\n}\n\n.sidebar-brand {\n  align-items: center;\n  border-bottom: 1px solid rgba(255, 255, 255, 0.08);\n  display: flex;\n  gap: 12px;\n  margin: -4px -16px 20px;\n  padding: 8px 16px 20px;\n}\n\n.brand-mark {\n  align-items: center;\n  background: linear-gradient(135deg, #3ddad7, #2a9d8f);\n  border-radius: 12px;\n  color: #ffffff;\n  display: flex;\n  font-size: 18px;\n  font-weight: 700;\n  height: 46px;\n  justify-content: center;\n  width: 46px;\n}\n\n.brand-copy {\n  display: flex;\n  flex-direction: column;\n}\n\n.brand-copy strong {\n  color: #ffffff;\n  font-size: 17px;\n}\n\n.brand-copy span {\n  color: #8da3a9;\n  font-size: 12px;\n}\n\n.sidebar-nav {\n  flex: 1;\n}\n\n.sidebar-menu {\n  list-style: none;\n  margin: 0;\n  padding: 0;\n}\n\n.sidebar-item {\n  border-radius: 10px;\n  color: #cbd5e1;\n  cursor: pointer;\n  display: block;\n  margin-bottom: 8px;\n  padding: 12px 16px;\n  transition: background 0.2s ease;\n}\n\n.sidebar-item:hover {\n  background: #12353f;\n}\n\n.sidebar-item.active {\n  background: #1d4ed8;\n  color: #ffffff;\n}\n\n.logout-button {\n  background: transparent;\n  border: 1px solid rgba(255, 255, 255, 0.08);\n  border-radius: 10px;\n  color: #cbd5e1;\n  cursor: pointer;\n  margin-top: auto;\n  padding: 12px 16px;\n  text-align: left;\n  margin-top: 629px;\n}\n\n.logout-button:hover {\n  background: #12353f;\n}\n"] }]
    }], null, { logoutClicked: [{
            type: Output
        }] }); })();
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(DashboardSidebarComponent, { className: "DashboardSidebarComponent", filePath: "src/app/shared/sidebar/sidebar.ts", lineNumber: 14 }); })();
