...
export class DashboardNavComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DashboardNavComponent, selectors: [["app-dashboard-nav"]], hostAttrs: [1, "app-dashboard-nav"], decls: 11, vars: 3, consts: [[1, "dashboard-topbar"], [1, "topbar-copy"], [1, "topbar-title"], [1, "wave"], [1, "topbar-subtitle"], [1, "right-tools"], [1, "user-badge"]], template: function DashboardNavComponent_Template(rf, ctx) { if (rf & 1) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DashboardNavComponent, [{
        type: Component,
        args: [{ selector: 'app-dashboard-nav', standalone: true, host: {
                    'class': 'app-dashboard-nav '
                }, imports: [CommonModule], template: "<header class=\"dashboard-topbar\">\n  <div class=\"topbar-copy\">\n    <div class=\"topbar-title\">\n      Hello , {{ user?.name || 'Student' }}\n      <span class=\"wave\">\uD83D\uDC4B</span>\n    </div>\n    <div class=\"topbar-subtitle\">{{ todayLabel }}</div>\n  </div>\n\n  <div class=\"right-tools\">\n    <div class=\"user-badge\">{{ user?.name?.charAt(0) || 'S' }}</div>\n  </div>\n</header>\n", styles: ["\n.dashboard-topbar {\n  align-items: center;\n  background: #ffffff;\n  border: 1px solid #e8e2db;\n  \n  box-shadow: 0 8px 24px rgba(15, 23, 42, 0.06);\n  display: flex;\n  justify-content: space-between;\n  padding: 16px 20px;\n  \n}\n\n.topbar-copy {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n\n.topbar-title {\n  color: #111827;\n  font-size: 1.65rem;\n  font-weight: 700;\n}\n\n.wave {\n  font-size: 1.3rem;\n  vertical-align: middle;\n}\n\n.topbar-subtitle {\n  color: #7c8798;\n  font-size: 0.92rem;\n}\n\n.topbar-tools {\n  align-items: center;\n  display: flex;\n  gap: 14px;\n}\n\n.search-box {\n  align-items: center;\n  background: #f4f1ec;\n  border-radius: 12px;\n  color: #98a2b3;\n  display: flex;\n  font-size: 0.92rem;\n  min-height: 44px;\n  min-width: 220px;\n  padding: 0 16px;\n}\n\n.user-badge {\n  align-items: center;\n  background: #5b5ce2;\n  border-radius: 999px;\n  color: #ffffff;\n  display: flex;\n  font-weight: 700;\n  height: 42px;\n  justify-content: center;\n  width: 42px;\n}\n\n@media (max-width: 900px) {\n  .dashboard-topbar {\n    align-items: flex-start;\n    flex-direction: column;\n    gap: 16px;\n  }\n\n  .topbar-title {\n    font-size: 1.3rem;\n  }\n\n  .topbar-tools {\n    width: 100%;\n  }\n\n  .search-box {\n    min-width: 0;\n    width: 100%;\n  }\n}\n"] }]
    }], () => [{ type: i1.AuthService }], null); })();
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(DashboardNavComponent, { className: "DashboardNavComponent", filePath: "src/app/shared/components/navbar/nav.ts", lineNumber: 15 }); })();
