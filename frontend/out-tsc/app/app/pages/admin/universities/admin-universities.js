...
export class AdminUniversitiesComponent {
    ...
    loadUniversities() {
        ...
        this.errorMessage = '';
        this.universityService.listAdminUniversities(this.selectedCountry).pipe(timeout(8000), finalize(() => {
